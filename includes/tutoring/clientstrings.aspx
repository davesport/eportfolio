...
var L_AttWrnLevTwo = "This type of attachment must be saved to disk. Right-click the link, and then click \'Save Link As\' to save the attachment.";
var L_IrmCopyRestrictedConv = "This type of attachment must be saved to disk. Open the message, right-click the link, and then click \'Save Link As\' to save the attachment.";
...
var L_Awy = "Away";
var L_BadSig = "The digital signature on this message isn\'t valid. The message contents may have been altered after the message was signed.";
...
var L_CExp = "The digital signature on this message isn\'t valid. The digital ID used to sign this message has expired.";
...
var L_FRP = "Do you want to forward only this occurrence or the series?";
...
var L_ErrAddBuddyToGroupFailed = "The contact {0} couldn\'t be added to the group {1}.";
var L_ErrAddGroupFailed = "The group {0} couldn\'t be added.";
...
var L_ErrArvMvFld = "You can’t move folders to your archive mailbox, but you can move individual items there. To automatically move content to your archive in the future, assign an archive policy to a folder or item.";
...
var L_ErrCopyBuddyFailed = "{0} couldn\'t be copied to the group {1}.";
var L_ErrDeclBdyTtl = "Decline Failed";
var L_ErrDeclBdy = "The contact request from {0} couldn\'t be declined.";
var L_ErrDelItms = "Some items cannot be deleted. They were either moved or already deleted, or access was denied.";
var L_ErrMvFldFailed = "Folder Move Failed";
var L_ErrCpFailedPF = "Some items couldn\'t be copied. This might be because some items are too large, the folder has reached its size limit, or you don\'t have permission to copy them.";
var L_ErrMvFailedPF = "Some items couldn\'t be moved. This may be because some items are too large, or the folder has reached its size limit, or you don\'t have sufficient permission.";
var L_ErrCpFailed = "Some items couldn\'t be copied. This may be because the folder has reached its size limit.";
var L_ErrMvFailed = "Some items could not be moved. This may be because the folder has reached its size limit.";
var L_ErrCpFailedOM = "Some items couldn\'t be copied. This could be because some items are too large, or the folder has reached its size limit, or you don\'t have permission to copy the items.";
var L_ErrMvFailedOM = "Some items couldn\'t be moved. This may be because some items are too large, or the folder has reached its size limit, or you do not have sufficient permission.";
...
var L_HttpErr = "Your network connection isn\'t available. If the problem continues, contact your helpdesk with this HTTP Status code: {0}.";
...
var L_IMPrivacyMigrationInProgress = "Your privacy settings are currently being updated. Your Contact List will be available shortly.";
var L_IMPrivacyMigrationNeeded = "Your privacy settings have been changed. Please sign in to IM on your desktop to complete the changes. If you\'re already signed in, please sign out, and then sign back in.";
...
var L_ErrRmblst = "{0} couldn\'t be removed from the Contact List.";
var L_ErrRmblstTtl = "Removal from IM Contact List Failed";
var L_ErrRemoveBuddyFromGroupFailed = "The contact {0} couldn\'t be deleted from the group {1}.";
var L_ErrRenameGroupFailed = "The group {0} couldn\'t be renamed to {1}.";
...
var L_ErrorSharingInArchive = "You can\'t share calendars from sharing invitations in your personal archive. Please move the sharing invitation to your mailbox and then try again.";
...
var L_ErrorCannotConnectToEws = "The action you tried to perform couldn\'t be completed because there\'s a configuration problem on the server. If the problem continues, contact your helpdesk.";
var L_ErrorCannotAuthenticateToEws = "The action you tried to perform couldn’t be completed because there’s a configuration problem on the server. If the problem continues, contact your helpdesk.";
var L_ErrorOwaForbiddenOnEws = "The action you tried to perform couldn\'t be completed because there\'s a configuration problem on the server. If the problem continues, contact your helpdesk.";
var L_ErrorEwsUnavailable = "A server configuration problem is preventing access to your account. If the problem continues, contact your helpdesk.";
...
var L_InvitedToConference = "is inviting you to a conference.";
var L_InvitedToConversation = "is inviting you to a conversation.";
var L_Invtng = "Inviting...";
var L_IsTypng = "is typing...";
var L_KBAb = "KB";
var L_LstMsg = "Last message received {0}{1} at {2}.";
var L_learnMore = "Learn more.";
...
var L_MailTipsExternalGroupSingle = "{0} member of this group is outside your organization.";
var L_MailTipsExternalGroupMultiple = "{0} members of this group are outside your organization.";
var L_MailTipsExternalGroups = "{0} members of these groups are outside your organization.";
...
var L_No = "No";
var L_NoInformation = "There is no information available for this person.";
var L_NoItems = "There are no items to show in this view.";
...
var L_NoSigCert = "The digital signature on this message can\'t be verified. The sender didn\'t include the digital ID used to sign the message.";
...
var L_ClckFllwLnk = "+Click to follow link";
...
var L_ErrRemGrp = "The group {0} couldn\'t be deleted.";
...
var L_SvAs = "Save as:";
var L_AttWrnSaveToDisk = "Right-click the link, and then click \'Save Link As\' to save the attachment. ";
...
var L_SgAlgUnsup = "The digital signature on this message can\'t be validated because the required security algorithm isn\'t supported.";
...
var L_AddCalDesp = "You can add a calendar from your organization or from the Internet.";
var L_InOrgCal = "Calendar from your organization";
var L_WebCal = "Calendar from the Internet";
var L_InOrgCalEg = "(Example: Tony Smith)";
var L_WebCalEg = "(Example: webcal:\/\/contoso\/soccer.ics)";
var L_CalUrl = "Calendar URL:";
var L_ErrorBadUri = "The URL you entered for the calendar isn\'t in the correct format.";
var L_MsgAnnotation = "Message Annotation";
var L_OpenMsgAnnotation = "Open Message Annotation";
var L_SaveMsgAnnotation = "Save";
var L_AnnoTooLongErr = "The annotation is {0} characters in length, which exceeds the maximum length of {1} characters. Please enter a shorter annotation.";
